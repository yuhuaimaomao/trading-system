...
class IndustryBoardCollector(ProxyBaseCollector):
    """行业板块采集器（精简版）"""
    ...
    REFERER_URL = "https://quote.eastmoney.com/center/boardlist.html#industry_board"
    ...
    def __init__(self, trade_date: str = None, task_mgr = None):
        ...
        self.logger.info(f"行业板块采集器初始化完成（精简版）")
...
if __name__ == '__main__':
    print('='*60)
    print('行业板块数据采集器 - 测试运行')
    print('='*60)
    
    try:
        collector = IndustryBoardCollector()
