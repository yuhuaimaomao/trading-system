...
def check_daily_loss_limit(daily_pnl: float, total_value: float,
...
def should_close_losing_positions(daily_pnl: float, total_value: float,
                                  max_loss_pct: float = 0.03) -> tuple[bool, str]:
    """检查是否需要清掉浮亏仓位"""
