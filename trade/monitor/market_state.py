...
class MarketStateMixin:
    ...
    def _assess_regime(
        self, pattern, index_price, prev_close, change_pct,
        ...
        return assess_regime(
            pattern=pattern, index_price=index_price, prev_close=prev_close,
            change_pct=change_pct, session_phase=_session_phase(),
            ma20=ma20, ma60=ma60, market_breadth=breadth,
            multi_day_downtrend=multi_day, outlook=outlook,
        )
