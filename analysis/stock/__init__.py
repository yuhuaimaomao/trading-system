...
from analysis.stock.formatter import to_cli, to_dict, to_telegram
from analysis.stock.registry import _registry, get_many, list_all
...
def _register_builtins():
    if "technical" not in _registry:
        from analysis.stock.analyzers.technical import TechnicalAnalyzer
        from analysis.stock.analyzers.money_flow import MoneyFlowAnalyzer
        from analysis.stock.analyzers.sector_attr import SectorAttrAnalyzer
...
class StockAnalyzer:
    ...
    def analyze(self, symbol: str, **params) -> StockAnalysisReport:
        ...
        return StockAnalysisReport(symbol=symbol, name=name,
